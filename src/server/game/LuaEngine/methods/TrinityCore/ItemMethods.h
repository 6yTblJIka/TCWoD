...
namespace LuaItem
{
    ...
    */
    ...
    /**
     * Returns the [Item] AppearanceModID
     *
     * @return uint32 item _bonusData.AppearanceModID
     */
    int GetAppearanceModId(Eluna* E, Item* item)
    {
        E->Push(item->GetAppearanceModId());
        return 1;
    }

    /**
     * Returns the [Item] ITEM_MODIFIER_TRANSMOG_APPEARANCE_MOD
     *
     * @return uint32 item ITEM_MODIFIER_TRANSMOG_APPEARANCE_MOD
     */
    int GetVisibleAppearanceModId(Eluna* E, Item* item)
    {
        E->Push(item->GetVisibleAppearanceModId());
        return 1;
    }
    ...
    ElunaRegister<Item> ItemMethods[] =
    {
        ...
        { "GetItemModifiedAppearance", &LuaItem::GetAppearanceModId },
        { "GetItemModifiedAppearanceId", &LuaItem::GetVisibleAppearanceModId },
